// HTML elements
const newGame/*botonEmpezarJuego*/ = document.querySelector(".empezar");
const firstStack/*pilaInicial*/ = document.querySelector("#pila-inicial");
const cartaMazo = document.querySelector(".carta-mazo");
const selectedCard/*seleccionada*/ = document.querySelector("#seleccionada");

// Constantes
const types/*tipos*/ = ["trebol", "diamante", "corazon", "espada"];
